...
OFILES = gba.o font.o game.o images/garbage.o images/start_screen.o images/runner.o score.o images/cactus_big.o images/cactus_small.o images/lose_screen.o utility.o images/bird.o 
